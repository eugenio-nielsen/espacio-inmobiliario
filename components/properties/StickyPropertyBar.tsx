...
export default function StickyPropertyBar({ precio, whatsappUrl }: { precio: string; whatsappUrl: string | null }) {
  ...
  return (
    <div className="property-sticky-bar">
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: 10.5, color: "var(--ink-400)", margin: 0, textTransform: "uppercase", letterSpacing: ".06em" }}>
          Precio
        </p>
        <p style={{ fontFamily: "var(--font-sans)", fontWeight: 700, fontSize: 18, color: "var(--gold-700)", margin: 0, lineHeight: 1, whiteSpace: "nowrap" }}>
          {precio}
        </p>
      </div>
